#if true // mini 뱅킹시스템 만들기 // 깊은복사 구현 // const함수 추가
...
// 깊은복사 구현
Account::Account(const Account& ref) : accId(ref.accId), haveMoney(ref.haveMoney)
{
...
int Account::SelectAccInfo(int selectedId)
{
